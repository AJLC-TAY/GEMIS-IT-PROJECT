...
if (qtr == '2'){
    var promotionMsg = "Promoting the student will directly enroll him/her to second semester. This action can not be undone."
} else {
    if(sectionLvl == 12){
        var promotionMsg = "Promoting the student means that he/she has compeleted the senior high curriculum."
    } else {
