...
$row_temp = $admin->query("SELECT can_enroll FROM schoolyear ORDER BY sy_id DESC LIMIT 1;");
...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="assets/logoSc.png"/>
    <!-- BOOTSTRAP -->
    <link rel="stylesheet" href="assets/css/bootstrap.min.css">

    <link href="assets/css/bootstrap-icons.css" rel="stylesheet" />
    <link href="assets/css/font-awesome.min.css" rel="stylesheet" />
    <link href="assets/css/bs-stepper.min.css" rel="stylesheet" />
    ...
    <body> 
        ...
        <footer class="site-footer">
            <div class="text-center">
                <p> &copy; Copyrights <strong>incognito</strong>. All Rights Reserved</p>
            </div>
        </footer>
