...
class Program implements JsonSerializable
{
    ...
    public function __construct($prog_code, $curr_code, $prog_desc)
    {
        ...
        $this->action = "<div class='d-flex justify-content-center'>"
                      . "<a href='program.php?prog_code=".$prog_code."&state=edit' class='btn btn-secondary btn-sm w-auto me-1' title='Edit Program'>Edit</a>"
                      . "<a href='program.php?prog_code=".$prog_code. "' class='btn btn-primary w-auto btn-sm' title='View Program'>View</a>"
                      . "</div>";
    }
...
class Subject implements JsonSerializable
{
    ...
    public function __construct($sub_code, $sub_name, $for_grd_level, $sub_semester, $sub_type)
    {
        ...
        $this->action = "<div class='d-flex justify-content-center'>"
                    ."<a href='subject.php?sub_code=".$sub_code."&state=edit' class='btn btn-secondary btn-sm w-auto me-1' title='Edit Subject'>Edit</a>"
                    ."<a href='subject.php?sub_code=".$sub_code."&state=view' class='btn btn-primary btn-sm w-auto' title='View Subject'>View</a>"
                    ."</div>";
    }
    ...
    public function set_program($program)
    {
        ...
        $this->action = "<div class='d-flex justify-content-center'>"
                        ."<a href='subject.php?prog_code=". $program ."&sub_code=". $sub_code ."&state=edit' class='btn btn-secondary w-auto me-1 btn-sm' title='Edit Subject'>Edit</a>"
                        ."<a href='subject.php?prog_code=". $program ."&sub_code=". $sub_code ."&state=view' class='btn btn-primary w-auto btn-sm' title='View Subject'>View</a>"
                        ."</div>";
    }
...
class Faculty implements JsonSerializable
{
    ...
    public function __construct($teacher_id, $last_name, $middle_name, $first_name, $ext_name, $birthdate, $age, $sex, $department, $cp_no, $email, $award_coor, $enable_enroll, $enable_edit_grd, $id_photo, $subjects=[])
    {
        ...
        $this->action = "<div class='d-flex justify-content-center'>"
                      ."<a href='faculty.php?id=$teacher_id&action=edit' class='btn btn-primary btn-sm w-auto me-1' title='Edit Faculty'>Edit</a>"
                      . "<a href='faculty.php?id=$teacher_id' role='button' class='btn btn-secondary btn-sm w-auto' title='View Faculty'>View</a>"
                      ."</div>";
...
class StudentAward extends Award implements JsonSerializable
{
    ...
    class Student implements JsonSerializable
    {
        ...
        // {
            ...
            $this->action = "<div class='d-flex justify-content-center'>"
                            ."<a href='studentForm.php?id=$stud_id' class='btn btn-primary btn-sm w-auto me-1' title='Edit Student'>Edit</a>"
                            . "<a href='studentInfo.php?id=$stud_id' role='button' class='btn btn-secondary btn-sm w-auto' title='View Student'>View</a>"
                            ."</div>";
