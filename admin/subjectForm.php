...
function getSubjectPageContent($state) {
    ...
    if ($state === 'view') {
        $readonly = 'readonly';
        $sub_type_readonly = 'readonly';
        $edit_btn_editable = '';
    }
    // $readonly = ($state === 'view') ? 'readonly' : '';
    // $sub_type_readonly = $readonly;
    // $edit_btn_editable = ($readonly === 'readonly') ? '' : 'disabled' ;
                            ...
                            ."<div class='row mt'>
                                <div class='col-8'>
                                    <div class='form-group row'>
                                        <label for='subjectCode1'  class='col-sm-2 col-form-label'>Subject code</label>
                                        <div class='col-sm-10'>
                                            <input type='text' name = 'code' class='form-control' id='sub-code' value='". $subject->get_sub_code() ."' {$readonly}>
                                        </div>
                                        <label for='subjectName1' class='col-sm-2 col-form-label'>Subject name</label>
                                        <div class='col-sm-10'>
                                            <input type='text' name = 'name' class='form-control' id='sub-name' value='{$sub_name}' {$readonly}>
                                        </div>
                                        <label for='subjectType1' class='col-sm-2 col-form-label'>Subject type</label>
                                        <div class='col-sm-10'>
                                            <select name='sub-type' class='form-select' id='sub-type' {$sub_type_readonly}>";
                                        ...
                                        <label for='subjectSemester1' class='col-sm-2 col-form-label'>Subject Semester</label>
                                        <div class='col-sm-10'>
                                            <select name='semester' class='form-select' id='semester' {$readonly}>";
                                            foreach ($semesters as $id => $value) { 
                                        ...
                                        <label for='grade-level' class='col-sm-2 col-form-label'>Grade Level</label>
                                        <div class='col-sm-10'>
                                            <select name='grade-level' class='form-select' id='grade-level' {$readonly}>";
                                            foreach ($grd_lvl as $id => $value) { 
                                                ...
                                                <tbody>";
                                                    foreach ($subjectGrade11 as $subGr11) {
                                                        ...
                                                        $form .= "<tr class='text-center'>
                                                            ...
                                                            <td scope='col'>{$sub_name}</td>
                                                            <td scope='col'>{$sub_type}</td>
                                                            <td scope='col'><input ". (in_array($sub_code, $prereq) ? 'checked' : '') ." class='form-check-input' type='radio' name='radio-{$sub_code}' value='pre-{$sub_code}' {$readonly}></td>
                                                            <td scope='col'><input ". (in_array($sub_code, $coreq) ? 'checked' : '') ." class='form-check-input' type='radio' name='radio-{$sub_code}' value='co-{$sub_code}' {$readonly}></td>
                                                        </tr>";
                                                    }
                                                    $form .="
                                                </tbody>
                                    ...
                                    <a href='' role='button' class='btn btn-secondary cancel-btn {$readonly} d-none'>Cancel</a>
                                    <input class='btn btn-success form-control' type='submit' value='Save' {$readonly}>
