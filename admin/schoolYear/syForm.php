        ...
        <div class="bs-stepper-content">
            ...
            <div id="step-2" class="content">
                <div class="card w-100 h-auto mt-4 p-4">
                    ...
                    <div class="form-group row row-cols-1 row-cols-lg-2 g-3">
                        <div class="col">
                            <div class="container">
                                <div class="row mt-3 justify-content-between">
                                    <label class="col-form-label col-auto fw-bold">Core Subject</label>
                                    <div class="col-auto p-2">
                                        <div class="form-check">
                                ...
                                <div class="row border overflow-auto" style="height: 350px;">
                        ...
                        <div class="col">
                            <div class="container">
                                <div class="row mt-3 justify-content-between">
                                    <label class="col-form-label col-auto fw-bold">Specialized | Applied Subject</label>
                                    <div class="col-auto p-2">
                                        <div class="form-check">
                                ...
                                <div class="row border overflow-auto" style="height: 350px;">
                                    <ul id="spap-list" class="list-group p-0">
                                        <?php 
                                        foreach($subjects['spap'] as $id => $value) {
                ...
                <div class="d-flex flex-row-reverse mt-4">
                    <a href="#" class="btn btn-success next">Next</a>
                    <a href="#" class="btn btn-secondary previous me-1">Back</a>
                </div>
            </div>
            <!-- STEP 2 END -->
            <!-- STEP 3 -->
