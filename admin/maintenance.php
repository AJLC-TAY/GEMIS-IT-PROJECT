                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mt ps-3">
                            ...
                            <div class="content">
                                <div class="card py-3 mb-3 p-2">
                                    <h5 class="ms-3">Backup Data</h5>
                                    <div class="ms-2">
                                        <div class="row">
                                            <div class="col-md-10 ">
                                                <p class="ms-2">This will export all the data that is currently recorded in the database. This will only make a copy of all records (curriculum, school personnel, and student records of any school year), which can be restored or deleted. </p>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="">
                                ...
                                <div class="card py-3 mb-3 p-2">
                                    <h5 class="ms-3">Reset System</h5>
                                    <div class="ms-2">
                                        <div class="row">
                                            <div class="col-md-10 ">
                                                <p class="ms-2">Resetting the system will delete all data and backup stored, which includes the admin and faculty members, student records, and curriculum data. </p>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="">
                                                    <button data-bs-toggle="modal" data-bs-target="#reset-confirmation-modal" class="btn btn-danger w-75">Reset</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="delete-confirmation-modal" tabindex="-1" aria-labelledby="modal confirmation msg" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="close btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
                    <button data-action="delete" class="btn btn-danger btn-sm close-btn action">Delete</button>
                </div>
            </div>
        </div>
    </div>
