            ...
            <div class="card body w-100 h-auto">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" type="text" name="last-name" value='<?php echo $lname ?>' aria-label="default input example" placeholder="Last Name">
                    </div>

                    <div class='col-6'>
                        <label class="col-form-label">First Name</label>
                        <input class="form-control" type="text" name="first-name" value='<?php echo $fname ?>' aria-label="default input example" placeholder="First Name">
                    </div>

                    <div class='col-6'>
                        <label class="col-form-label">Middle Name</label>
                        <input class="form-control" type="text" name="middle-name" value='<?php echo $mname ?>' aria-label="default input example" placeholder="Middle Name">
                    </div>

                    <div class='col-4'>
                        <label class="col-form-label">Suffix</label>
                        <input class="form-control" type="text" name="ext-name" value='<?php echo $extname ?>' placeholder="Suffix">
                    </div>
                    ...
                    <div class='col-4'>
                        ...
                        <input class="form-control" type="text" name='birth-place' value='<?php echo $birth_place ?>' aria-label="default input example" placeholder="Birth Place">
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" type="text" name='mother-tongue' value='<?php echo $mother_tongue ?>' aria-label="default input example" placeholder="Mother Tongue">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        ...
                        <input class="form-control" type="number" name='house-no' value='<?php echo $house_no ?>' aria-label="default input example" placeholder="House No.">
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" type="text" name='city-muni' value='<?php echo $city ?>' aria-label="default input example" placeholder="City/Municipality">
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <input class="form-control" type="number" name='zip-code' value='<?php echo $zip ?>' aria-label="default input example" placeholder="Zip Code">
                    </div>
                </div>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class='form-row row'>
                        <div class='form-group col-md-6'>
                            ...
                            <input id='f_lastname' type='text' class='form-control' name='f_lastname' value='<?php if (empty($father_last_name)) {echo "";} else {echo $father_last_name;} ?>' placeholder='Last Name'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='f_firstname'>First Name</label>
                            <input id="f_firstname" type='text' class='form-control' name='f_firstname' value='<?php if (empty($father_first_name)) {echo "";} else {echo $father_first_name;} ?>' placeholder='First Name'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='middlename'>Middle Name</label>
                            <input id='f_middlename' type='text' class='form-control' name='f_middlename' value='<?php if (empty($father_middle_name)) { echo "";} else {echo $father_middle_name;} ?>' placeholder='Middle Name'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='f_extensionname'>Extension Name</label>
                            <input id='f_extensionname' type='text' class='form-control' name='f_extensionname' value='<?php if (empty($father_ext_name)) {echo "";} else {echo $father_ext_name;} ?>' placeholder='Extension Name'>
                        </div>
                    </div>
                    <div class='form-row row mb-3'>
                        <div class='form-group col-md-6'>
                            <label for='f_contactnumber'>Contact Number</label>
                            <input id="f_contactnumber" type='text' class='form-control' name='f_contactnumber' value='<?php if (empty($father_cp_no)) {echo "";} else {echo $father_cp_no;} ?>' placeholder='Contact Number'>
                        </div>
                        <div class='form-group col-md-6'>
                    ...
                    <div class='form-row row'>
                        <div class='form-group col-md-6'>
                            ...
                            <input id="m_lastname" type='text' class='form-control' name='m_lastname' value='<?php if (empty($mother_last_name)) {echo "";} else {echo $mother_last_name; } ?>' placeholder='Last Name'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='m_firstname'>First Name</label>
                            <input id = "m_firstname" type='text' class='form-control' name='m_firstname' value='<?php if (empty($mother_first_name)) {echo "";} else {echo $mother_first_name;} ?>' placeholder='First Name'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='m_middlename'>Middle Name</label>
                            <input id='m_middlename' type='text' class='form-control' name='m_middlename' value='<?php if (empty($mother_middle_name)) {echo "";} else {echo $mother_middle_name; } ?>' placeholder='Middle Name'>
                        </div>
                    </div>
                    <div class='form-row row mb-3'>
                        <div class='form-group col-md-6'>
                            <label for='m_contact'>Contact Number</label>
                            <input id='m_contact' type='text' class='form-control' name='m_contactnumber' value='<?php if (empty($mother_cp_no)) {echo "";} else {echo $mother_cp_no;} ?>' placeholder='Contact Number'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='m_occupation'>Occupation</label>
                            <input id="m_occupation" type='text' class='form-control' name='m_occupation' value='<?php if (empty($mother_occupation)) {echo "";} else {echo $mother_occupation;} ?>' placeholder='Occupation'>
                    ...
                    <div class='form-row row'>
                        ...
                        <div class='form-group col-md-6'>
                            ...
                            <input id="g_middlename" type='text' class='form-control' name='g_middlename' value='<?php echo $guardian_middle_name ?>' placeholder='Middle Name'>
                        </div>

                    </div>
                    <div class='form-row row'>
                        <div class='form-group col-md-6'>
                            <label for='g_contactnumber'>Contact Number</label>
                            <input id='g_contactnumber' type='text' class='form-control' name='g_contactnumber' value='<?php echo $guardian_cp_no ?>' placeholder='Contact Number'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label for='g_relationship'>Relationship</label>
                            <input id='g_relationship' type='text' class='form-control' name='relationship' value='<?php echo $guardian_relationship ?>' placeholder='Relationship'>
                        </div>
                    </div>
                </div>
            </div>
